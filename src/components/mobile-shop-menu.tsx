...
const productRows: MenuItem[] = [
  {
    ...
    children: [
      ...
      { label: "Dry Cabinets", href: "/c/bags", icon: Box, image: img.storage },
      { label: "Lens Accessories", href: "/c/accessories?sub=filters", icon: Search, image: img.lens },
      ...
      { label: "Photo Albums, Frames & Storage", href: "/c/storage", icon: Package, image: img.storage },
      { label: "Mobile Photography", href: "/c/gimbals?sub=phone-gimbals", icon: Smartphone, image: img.drone },
    ],
  },
  {
    ...
    children: [
      ...
      { label: "Backgrounds & Supports", href: "/c/studio?sub=background-stands", icon: Package, image: img.studio },
      { label: "Studio Equipment", href: "/c/studio", icon: Box, image: img.studio },
      { label: "Continuous Lighting", href: "/c/lighting?sub=led-lights", icon: Sparkles, image: img.lighting },
      { label: "Light Modifiers", href: "/c/lighting?sub=softboxes", icon: Sparkles, image: img.lighting },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "iPads & Tablets", href: "/c/computers?sub=laptops", icon: Smartphone, image: img.computer },
      ...
      { label: "Drives & Data Storage", href: "/c/storage", icon: Package, image: img.memory },
    ],
  },
  {
    label: "Video & Stabilizers",
    href: "/c/gimbals",
    icon: Video,
    image: img.video,
    children: [
      { label: "Video Cameras", href: "/c/cameras?sub=cinema", icon: Video, image: img.video },
      { label: "Camcorders", href: "/c/cameras?sub=camcorders", icon: Camera, image: img.video },
      { label: "Video Lenses", href: "/c/lenses?sub=cine", icon: Search, image: img.lens },
      { label: "Video Lens Accessories", href: "/c/accessories", icon: Package, image: img.battery },
      { label: "Video Stabilizers & Supports", href: "/c/gimbals", icon: Wrench, image: img.tripod },
      { label: "Video Accessories", href: "/c/accessories", icon: Package, image: img.storage },
      { label: "Bags & Cases", href: "/c/bags", icon: Package, image: img.battery },
      { label: "Video Memory Cards", href: "/c/storage?sub=sd-cards", icon: Package, image: img.memory },
      { label: "Post Production Equipment", href: "/c/computers", icon: Laptop, image: img.computer },
      { label: "Teleprompters", href: "/c/studio", icon: Video, image: img.video },
    ],
  },
  { label: "Audio", href: "/c/audio", icon: Headphones, image: img.audio },
  { label: "Memory & Storage", href: "/c/storage", icon: Monitor, image: img.storage },
  { label: "Bags & Cases", href: "/c/bags", icon: Package, image: img.storage },
  {
    label: "Drones",
    href: "/c/drones",
    icon: Camera,
    ...
    children: [
      ...
      { label: "Drone Accessories", href: "/c/drones?sub=drone-accessories", icon: Package, image: img.tripod },
      { label: "DJI Drones", href: "/c/drones", icon: Camera, image: img.drone },
      { label: "Autel Drones", href: "/c/drones", icon: Camera, image: img.drone },
    ],
  },
  { label: "Studio Gear", href: "/c/studio", icon: Box, image: img.studio },
];
